  ...
  return (
    <section id="portfolio" className="relative py-28 bg-[#0A0A0A] border-b border-artistic-border scroll-mt-20">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* Header Block */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-16" id="portfolio-header-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="portfolio-grid-container">
        ...
        {selectedProject && (
          ...
          >
            <div className="bg-[#121212] border border-artistic-border rounded-none w-full max-w-2xl overflow-hidden shadow-2xl relative">
